      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
        ...
        <tbody className='text-gray-700'>
          {enrolledCourses.map((course, index) => {
            ...
            const progressRatio = progress.totalLectures ? progress.lectureCompleted / progress.totalLectures : 0
            ...
            return (
              <tr key={index} className='border-b border-gray-500/20'>
                ...
                <td className='px-4 py-3 max-sm:text-right'>
                  <button onClick={()=> navigate('/player/' +course._id)} className={`px-3 sm:px-5 py-1.5 sm:py-2 rounded-full text-white ${isCompleted ? 'bg-green-600' : 'bg-blue-600'}`}>
